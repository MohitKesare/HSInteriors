  ...
  return (
    <footer className="relative w-full h-fit bg-[#2C2C2C]  flex flex-col items-center justify-center">
      ...
      <div className="w-[90%] flex justify-between">
        <div className="flex flex-col w-fit my-8 space-y-4">
          <div>
            <p className="outfit-400-16">Address:</p>
            <p className="outfit-400-16 text-[#C4A386]">
              Infont od Dmart, Hinjewadi, Pune
            </p>
          </div>
          <div>
            <p className="outfit-400-16">Contact:</p>
            <p className="outfit-400-16 text-[#C4A386]">9767457282</p>
            <p className="outfit-400-16 text-[#C4A386]">hsinterior@gmail.com</p>
          </div>
        ...
        <div className="flex flex-col w-fit mr-8 text-left space-y-2 mt-4">
          <p className="outfit-400-16 ">Pages</p>
          <p className="outfit-400-16 text-[#C4A386]">Home</p>
          <p className="outfit-400-16 text-[#C4A386]">Services</p>
          <p className="outfit-400-16 text-[#C4A386]">About Us</p>
          <p className="outfit-400-16 text-[#C4A386]">Our Work</p>
          <p className="outfit-400-16 text-[#C4A386]">Contact</p>
        </div>
      </div>
      <div className="h-[1px] w-[90%] bg-[#C4A386] mb-3"></div>
