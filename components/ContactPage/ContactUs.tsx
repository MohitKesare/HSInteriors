        ...
        <div className="w-full h-full  mt-8 flex ">
          <div className="w-[50%] h-full flex flex-col ">
            <div className="flex space-x-10 ml-10 mt-5">
              <div>
                <h3 className="outfit-400-20 text-[#2c2c2c]">First Name*</h3>
                <input
                  type="text"
                  name="firstName"
              ...
              <div>
                <h3 className="outfit-400-20 text-[#2c2c2c]">Last Name*</h3>
                <input
                  type="text"
                  name="LastName"
                  className="border-b-2 border-[#C4A386] mt-5 focus:outline-none focus:border-[#996830] text-black placeholder:text-gray-400"
            ...
            <div className="flex space-x-10 ml-10 mt-5">
              <div>
                <h3 className="outfit-400-20 text-[#2c2c2c]">Email*</h3>
                <input
                  type="email"
                  name="email"
                  className="border-b-2 border-[#C4A386] mt-5 focus:outline-none focus:border-[#996830] text-black placeholder:text-gray-400"
              ...
              <div>
                <h3 className="outfit-400-20 text-[#2c2c2c]">Phone</h3>
                <input
                  type="text"
                  name="LastName"
                  className="border-b-2 border-[#C4A386] mt-5 focus:outline-none focus:border-[#996830] text-black placeholder:text-gray-400"
            ...
            <div className="flex flex-col mt-10 ml-10">
              <label className="block font-semibold mb-1 outfit-400-20 text-[#2c2c2c]">
                Services you want:
              </label>
              <div className="flex space-x-5 mt-5">
                <label className="flex items-center gap-2">
                  <input type="checkbox" name="marbleFitting " />
                  <p className="outfit-400-20 text-[#2c2c2c]">Marble Fitting</p>
                </label>
                <label className="flex items-center gap-2">
                  <input type="checkbox" name="tileInstallation " />
                  <p className="outfit-400-20 text-[#2c2c2c]">
                    Tile Installations
                  </p>
                </label>
                <label className="flex items-center gap-2">
            ...
            <div className="ml-10 mt-6 flex flex-col">
              <p className="outfit-400-20 text-[#2c2c2c]">Message</p>
              <textarea
                name="message"
